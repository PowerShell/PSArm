...
in order to count the number of ARM deployments PSArm powers.
This helps us understand how useful PSArm is to Azure customers
and aids development of the project.
